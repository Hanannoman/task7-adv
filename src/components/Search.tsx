    ...
    <div className="w-full mx-auto mt-[60px] bg-white/20 p-[20px] rounded-xl">
      ...
      <div className="flex mb-0">
        <button
          ...
          className={`flex items-center space-x-[10px] px-4 py-2.5 rounded-t-xl font-semibold transition text-lg  font-[family-name:var(--font-open-sans)] ${
            activeTab === 'public'
        ...
        <button
          ...
          className={`flex items-center space-x-2 px-6 py-2.5 rounded-t-xl font-semibold transition text-sm  font-[family-name:var(--font-open-sans)] ${
            activeTab === 'private'
      ...
      <div className="bg-white backdrop-blur-md p-4 rounded-b-xl rounded-tr-xl shadow-xl flex flex-wrap lg:flex-nowrap items-center justify-between gap-4">
        ...
        {searchFields.map((field, index) => (
          <div 
            key={field.id} 
            className={`flex-1 ${field.width} px-3 ${
              index !== searchFields.length - 1 ? 'border-r border-white/30' : ''
            }`}
          >
